...
const allObjects = {
	intersect: {
		rectPoint: {main: <DrawObj | null>null, second: <DrawObj | null>null, text: <Text_isIntersect | null>null},
		rects: {main: <DrawObj | null>null, second: <DrawObj | null>null, text: <Text_isIntersect | null>null},
		circlePoint: {main: <DrawObj | null>null, second: <DrawObj | null>null, text: <Text_isIntersect | null>null},
		circles: {main: <DrawObj | null>null, second: <DrawObj | null>null, text: <Text_isIntersect | null>null},
	},
}
...
function addListenerToDraw(buttonId: string, keyGroup: KeyGroup, key: Key, shape: "point" | "rect" | "circle")
{
...
function endDrawing(keyGroup: KeyGroup, key: Key)
{
...
function isIntersect(keyGroup: KeyGroup, key: Key)
{
	const objects = allObjects[keyGroup][key];
	...
	if (objects.text != null) objects.text.intersect = intersect;
}
...
function drawOne(keyGroup: KeyGroup, key: Key)
{
	const ctx = allContext[keyGroup][key];
	const objects = allObjects[keyGroup][key];
...
type KeyGroup = "intersect";
type Key = "rectPoint" | "rects" | "circlePoint" | "circles";