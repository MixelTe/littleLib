...
function addListenerToDraw(buttonId: string, key: Key, shape: "point" | "rect" | "circle")
{
	...
	canvas.addEventListener("click", (e: MouseEvent) =>
	{
		if (allDrawToggled[key])
		{
			...
			drawOne(key);
			if (allDrawToggled[key]) Lib.canvas.drawCoords(ctx, e.offsetX, e.offsetY);
		}
	});
